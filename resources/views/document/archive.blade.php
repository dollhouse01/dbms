...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item" aria-current="page">{{ __('Archive Document') }}</li>
@endsection
                ...
                <div class="card-header">
                    <div class="row align-items-center g-2 flex-wrap">
                        <div class="col-12 col-md">
                            <h5>{{ __('Archive Document') }}</h5>
                        </div>
                        <div class="col-12 col-md-auto">
                            {{ Form::open(['method' => 'get', 'route' => 'document.archive', 'id' => 'document-archive-table', 'class' => 'attendance-date']) }}
