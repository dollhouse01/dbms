                ...
                <div class="row align-items-center justify-content-between">
                    <div class="col-lg-6 col-xl-6">
                        <h1 class="mt-sm-3 mb-sm-4 f-w-600 wow fadeInUp" data-wow-delay="0.2s">
                            ...
                            @else
                                {{ __('DRMS SaaS - Digital Record Management System') }}
                            @endif
                        </h1>
                        <h4 class="mb-sm-4 text-muted wow fadeInUp" data-wow-delay="0.4s">
                            ...
                            @else
                                {{ __('Document and Records Management System (DRMS SaaS) software refers to the various features and functionalities that the software offers to help organizations manage their digital documents effectively.') }}
                            @endif
                        </h4>
                        @php
                    ...
                    <div class="row justify-content-center title">
                        <div class="col-md-9 col-lg-6 text-center">
                            @if (env('APP_MODE') == 'demo')
                                <h3 class="text-danger">{{ __('Note') }} :
                                    {{ __('All data shown here is dummy data provided to help clients better understand the features, functionality, and workflow of the platform') }}
                                </h3>
                            @endif
                                ...
                                <div class="card price-card ">
                                    <div class="card-body">
                                        ...
                                        <ul class="list-group list-group-flush product-list">
                                            ...
                                            @else
                                                <li class="list-group-item">{{ __('Disable Open Ai Support') }}</li>
                                            @endif
                                            @if ($subscription->enabled_n8n)
                                                <li class="list-group-item enable">{{ __('Enabled N8n') }}
                                                </li>
                                            @else
                                                <li class="list-group-item">{{ __('Disable N8n') }}</li>
                                            @endif
                                ...
                                <div class="accordion-item">
                                    ...
                                    <div id="flush-collapseOne" class="accordion-collapse collapse show"
                                        ...
                                        <div class="accordion-body text-muted">
                                            {{ __('Our software provides a range of features including automation tools,real-time analytics, cloud-based access, secure data storage, seamlessintegrations, and customizable solutions tailored to your business needs.') }}
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-item">
                ...
                <div class="row">
                    <div class="col-md-4 wow fadeInUp" data-wow-delay="0.2s">
                        ...
                        <h4 class="my-3 text-white">
                            {{ !empty($Section_10_content_value['Sec10_title']) ? $Section_10_content_value['Sec10_title'] : __('About DRMS SaaS') }}
                        </h4>
