                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="cart-action">
                                                {!! Form::open(['method' => 'DELETE', 'route' => ['users.destroy', [encrypt($user->id), 'type' => 'client']]]) !!}

                                                @can('show client')
                                                    <a class="avtar avtar-xs btn-link-warning text-warning"
                                                        data-bs-toggle="tooltip" data-bs-original-title="{{ __('Show') }}"
                                                        href="{{ route('client.show', encrypt($user->id)) }}">
                                                ...
                                                @can('edit client')
                                                    <a class="avtar avtar-xs btn-link-secondary text-secondary customModal"
                                                        ...
                                                        data-url="{{ route('client.edit', encrypt($user->id)) }}"
