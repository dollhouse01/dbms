...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item" aria-current="page">{{ __('Reminder') }}</li>
@endsection
    ...
    <div class="row">
        <div class="col-12">
            <div class="card table-card">
                ...
                <div class="card-body pt-0" id="reminder-report">
...
@push('script-page')
    <script>
        ...
        $(document).ready(function() {
            $('#reminder-table').on('submit', function(e) {
                e.preventDefault();
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        $('#reminder-report').html(response.html);
                        datatable();
                    },
                    error: function(xhr) {
