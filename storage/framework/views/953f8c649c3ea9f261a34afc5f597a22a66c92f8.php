        ...
        <div class="m-header">
            <a href="#" class="b-brand text-primary">
                <?php if($theme_mode == 'dark'): ?>
                    <img src="<?php echo e(asset(Storage::url('upload/logo/')) . '/' . (isset($light_logo) && !empty($light_logo) ? $light_logo : 'light_logo.png')); ?>"
        ...
        <div class="navbar-content">
            <ul class="pc-navbar">
                ...
                <?php if(Gate::check('manage document') ||
                    ...
                    <?php if(Gate::check('manage document')): ?>
                        <li
                            class="pc-item <?php echo e(in_array($routeName, ['document.index', 'document.show', 'document.comment', 'document.reminder', 'document.version.history', 'document.share', 'document.send.email']) ? 'active' : ''); ?>">
                    ...
                    <?php if(Gate::check('archive document')): ?>
                        <li class="pc-item <?php echo e(Request::route()->getName() == 'document.archive' ? 'active' : ''); ?>">
                            <a href="<?php echo e(route('document.archive')); ?>" class="pc-link">
                                <span class="pc-micon"><i data-feather="archive"></i></span>
                                <span class="pc-mtext"><?php echo e(__('Archive Documents')); ?></span>
                            </a>
                        </li>
                    <?php endif; ?>
...
<?php /**PATH /var/www/resources/views/admin/menu.blade.php ENDPATH**/ ?>