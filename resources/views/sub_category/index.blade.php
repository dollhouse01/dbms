                            ...
                            <tbody>
                                @foreach ($sub_categories as $sub_category)
                                    <tr role="row">
                                        ...
                                        <td>
                                            {{ dateFormat($sub_category->created_at) }} {{ timeFormat($sub_category->created_at) }}
                                        </td>
                                        @if (Gate::check('edit sub category') || Gate::check('delete sub category'))
                                            <td class="text-right">
                                                <div class="cart-action">
                                                    {!! Form::open(['method' => 'DELETE', 'route' => ['sub-category.destroy', encrypt($sub_category->id)]]) !!}
                                                    ...
                                                    @if (Gate::check('edit sub category'))
                                                        <a class="avtar avtar-xs btn-link-secondary text-secondary customModal" data-bs-toggle="tooltip"
                                                            ...
                                                            data-url="{{ route('sub-category.edit', encrypt($sub_category->id)) }}"
