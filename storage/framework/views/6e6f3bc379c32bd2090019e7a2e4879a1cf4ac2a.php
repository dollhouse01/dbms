                ...
                <div class="row align-items-center justify-content-between">
                    <div class="col-lg-6 col-xl-6">
                        <h1 class="mt-sm-3 mb-sm-4 f-w-600 wow fadeInUp" data-wow-delay="0.2s">
                            ...
                            <?php else: ?>
                                <?php echo e(__('DRMS SaaS - Digital Record Management System')); ?>
                        ...
                        <h4 class="mb-sm-4 text-muted wow fadeInUp" data-wow-delay="0.4s">
                            ...
                            <?php else: ?>
                                <?php echo e(__('Document and Records Management System (DRMS SaaS) software refers to the various features and functionalities that the software offers to help organizations manage their digital documents effectively.')); ?>
                    ...
                    <div class="row justify-content-center title">
                        <div class="col-md-9 col-lg-6 text-center">
                            <?php if(env('APP_MODE') == 'demo'): ?>
                                <h3 class="text-danger"><?php echo e(__('Note')); ?> :
                                    <?php echo e(__('All data shown here is dummy data provided to help clients better understand the features, functionality, and workflow of the platform')); ?>
                                        ...
                                        <ul class="list-group list-group-flush product-list">
                                            ...
                                            <?php if($subscription->enabled_openai): ?>
                                                <li class="list-group-item enable">
                                                    <?php echo e(__('Enabled Open Ai Support')); ?>

                                                </li>
                                            <?php else: ?>
                                                <li class="list-group-item"><?php echo e(__('Disable Open Ai Support')); ?></li>
                                            <?php endif; ?>
                                            <?php if($subscription->enabled_n8n): ?>
                                                <li class="list-group-item enable"><?php echo e(__('Enabled N8n')); ?>

                                                </li>
                                            <?php else: ?>
                                                <li class="list-group-item"><?php echo e(__('Disable N8n')); ?></li>
                                            <?php endif; ?>
                            ...
                            <div class="swiper-wrapper">
                                ...
                                <?php else: ?>
                                    <div class="swiper-slide">
                                        ...
                                        <p><?php echo e(__('Complete Social profile with all possible option')); ?></p>
                                    </div>
                                    <div class="swiper-slide">
                                        <img src="assets/images/landing/slider-light-2.png" alt="images"
                                            class="img-fluid" />
                                        <h3>
                                            <?php echo e(__('Mail/Message App')); ?>

                                            <i class="ti ti-link"></i>
                                        </h3>
                                        <p><?php echo e(__('Complete Mail/Message App with all possible option')); ?></p>
                                    </div>
                                    <div class="swiper-slide">
                                        ...
                                        <p><?php echo e(__('Complete Chat App with all possible option')); ?></p>
                                    </div>
                                    <div class="swiper-slide">
                                        <img src="assets/images/landing/slider-light-4.png" alt="images"
                                            class="img-fluid" />
                                        <h3>
                                            <?php echo e(__('Kanban App')); ?>

                                            <i class="ti ti-link"></i>
                                        </h3>
                                        <p><?php echo e(__('Complete Kanban App with all possible option')); ?></p>
                                    </div>
                                    <div class="swiper-slide">
                                        <img src="assets/images/landing/slider-light-5.png" alt="images"
                                            class="img-fluid" />
                                        <h3>
                                            <?php echo e(__('Calendar App')); ?>

                                            <i class="ti ti-link"></i>
                                        </h3>
                                        <p><?php echo e(__('Complete Calendar App with all possible option')); ?></p>
                                    </div>
                                    <div class="swiper-slide">
                                        <img src="assets/images/landing/slider-light-6.png" alt="images"
                                            class="img-fluid" />
                                        <h3>
                                            <?php echo e(__('Ecommerce App')); ?>

                                            <i class="ti ti-link"></i>
                                        </h3>
                                        <p><?php echo e(__('Complete Ecommerce App with all possible option')); ?></p>
                                    </div>
                                <?php endif; ?>
                            </div>
                                ...
                                <div class="accordion-item">
                                    ...
                                    <div id="flush-collapseOne" class="accordion-collapse collapse show"
                                        ...
                                        <div class="accordion-body text-muted">
                                            <?php echo e(__('Our software provides a range of features including automation tools,real-time analytics, cloud-based access, secure data storage, seamlessintegrations, and customizable solutions tailored to your business needs.')); ?>
                ...
                <div class="row">
                    <div class="col-md-4 wow fadeInUp" data-wow-delay="0.2s">
                        ...
                        <h4 class="my-3 text-white">
                            <?php echo e(!empty($Section_10_content_value['Sec10_title']) ? $Section_10_content_value['Sec10_title'] : __('About DRMS SaaS')); ?>
...
<?php /**PATH /var/www/resources/views/layouts/landing.blade.php ENDPATH**/ ?>