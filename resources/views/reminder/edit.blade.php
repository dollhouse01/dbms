...
<div class="modal-body">
    <div class="row">
        ...
        <div class="form-group col-md-6">
            ...
            {{Form::select('document_id',$documents,null,array('class'=>'form-control select2'))}}
        </div>
        <div class="form-group col-md-6">
            {{Form::label('assign_user',__('Assign Users'),array('class'=>'form-label'))}}
            {{Form::select('assign_user[]',$users,explode(',',$reminder->assign_user),array('class'=>'form-control select2','multiple'))}}
        </div>
